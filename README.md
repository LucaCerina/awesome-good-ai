...
## What will *NOT* be in this list
* AI agents, AI projects using artificial text extruders from Big Tech companies AND/OR models built on distillation of those.
* Any project with AI generated PR, or coding LLMs in their contributors.
